...
function Login() {
  ...
  return (
    <div className="bg-[#0B1220] w-[100vw] min-h-[100vh] flex items-center justify-center px-4 py-10">
      <form
        className="w-full md:w-[800px] min-h-[580px] bg-white/5 border border-white/10 backdrop-blur-lg shadow-2xl shadow-blue-500/10 rounded-2xl flex relative overflow-hidden"
      ...
      >
        ...
        <div className="md:w-[50%] w-[100%] h-full flex flex-col items-center justify-center gap-4 p-8">
          ...
          <span
            className="text-[13px] cursor-pointer text-gray-400 hover:text-blue-400 transition-all duration-300"
